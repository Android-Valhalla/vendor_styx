...
PLATFORM_STYX_VERSION := 4.0.0_ALPHA1
PLATFORM_STYX_VERSION_INCR := alpha1
PLATFORM_VALHALLA_VERSION := VALHALLA
PLATFORM_STYX_VERSION := $(PLATFORM_VALHALLA_VERSION)-$(PLATFORM_STYX_VERSION)-$(shell date +%Y%m%d%S)
